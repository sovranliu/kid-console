...
public class getRevokeBooks implements IAction {
	...
	public String execute(Visitor visitor, Context context) throws Exception {
		...
		Page<BookChangeRequest> page=bookChangeRequestService.queryByCondPage(null, null, null, "1", "2", begin, limit);
		if(page!=null&&page.getResultList()!=null){
			...
			for(BookChangeRequest request:bcrList){
				...
				if(book!=null){
					...
					String bookTime=bookRepositoryService.getBookTimeByBookTimeId(bookId);
