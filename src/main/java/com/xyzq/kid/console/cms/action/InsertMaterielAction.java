 ...
 */
@MaggieAction(path = "kid/console/insertMateriel")
public class InsertMaterielAction extends AdminAjaxAction {
	@Autowired
	 ...
	 * 日志对象
	 */
	public static Logger logger = LoggerFactory.getLogger(InsertMaterielAction.class);
	/**
	 * 动作执行
	 *
	 * @param visitor 访问者
